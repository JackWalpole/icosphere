    ...
    def __init__(self, level):       
        ...
        for l in range(1, self.level):
            ...
            for tri in self.triangles:
                ...
                p = tri.pts
                p.append(self._getMiddlePoint( tri.pts[0], tri.pts[1], midPointDict))
                p.append(self._getMiddlePoint( tri.pts[0], tri.pts[2], midPointDict))
                p.append(self._getMiddlePoint( tri.pts[1], tri.pts[2], midPointDict))
